...
export class Migration20220907125758 extends Migration {
  public async up(): Promise<void> {
    ...
    this.addSql(
      'create table `transactions` (`transactionId` int unsigned not null auto_increment primary key, `source` varchar(255) not null, `sum` decimal(10,2) not null, `description` varchar(1000) null, `date` datetime not null, `userId` int unsigned not null) default character set utf8mb4 engine = InnoDB;',
    );
